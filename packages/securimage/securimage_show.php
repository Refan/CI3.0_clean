...
$img->multi_text_color = array(new Securimage_Color("#8a8a8a"));
$img->use_multi_text = true;
$img->num_lines = 0;
$img->line_color = new Securimage_Color("#FFFF00");

$img->multi_text_color = array(new Securimage_Color("#207e3b"),
                               new Securimage_Color("#a4282c"),
                               new Securimage_Color("#707029"),
                               new Securimage_Color("#141c8a"),
							   new Securimage_Color("#ff8c00"),
							   new Securimage_Color("#ba55d3")
                               );
